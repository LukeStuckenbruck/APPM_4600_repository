...
### SOLUTIONS
# steepest descent converges to [x,y,z] = [1.74982194e-09 9.99990945e-02 9.99999991e-01]
#   in 7 iterations
# This is more iterations than Newton's Method
...
def driver():
    ...
    [xstar,gval,ier,iterations] = SteepestDescent(x0,tol,Nmax)
...
def SteepestDescent(x,tol,Nmax):
    ...
    for its in range(Nmax):
        ...
        if abs(gval - g1)<tol:
            ier = 0
            return [x,gval,ier,iterations]

        iterations += 1

    print('max iterations exceeded')    
    ier = 1        
    return [x,g1,ier,iterations]
